...
export function CompressOptions() {
  return (
    <div className="w-full max-w-3xl">
      ...
      <RadioGroup defaultValue="recommended" className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Less quality, high compression. Perfect for long-term archiving where quality isn't priority.
            </p>
        ...
        <div>
          ...
          >
            ...
            <div className="font-bold text-lg text-slate-800">Recommended Compression</div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Good quality, good compression. The standard option for most files.
            </p>
            <div className="mt-auto pt-4 text-xs font-bold text-green-700">
               -40% File Size
            </div>
        ...
        <div>
          <RadioGroupItem value="less" id="less" className="peer sr-only" />
          <Label
            htmlFor="less"
            className="relative flex flex-col gap-4 rounded-xl border-2 border-muted bg-white p-6 cursor-pointer hover:border-primary/50 transition-all peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-green-50/50"
          >
            ...
            <div className="font-bold text-lg text-slate-800">Less <br/>Compression</div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              High quality, less compression. Ideal for images and high-fidelity documents.
            </p>
            <div className="mt-auto pt-4 text-xs font-bold text-green-700">
               -10% File Size
            </div>
